...
class ConfigController extends Controller
{
    ...
    protected function getConfigs(): array
    {
        return [
            'claude' => [
                'title' => 'CLAUDE.md',
                'local_path' => '/ttyd-user-home/.claude/CLAUDE.md',
                'container' => 'pocket-dev-ttyd',
                'container_path' => '/home/devuser/.claude/CLAUDE.md',
                'syntax' => 'markdown',
                'validate' => false,
                'reload_cmd' => null,
            ],
            'settings' => [
                ...
                'local_path' => '/ttyd-user-home/.claude/settings.json',
                'container' => 'pocket-dev-ttyd',
                'container_path' => '/home/devuser/.claude/settings.json',
                'syntax' => 'json',
                'validate' => false,
                'reload_cmd' => null,
            ],
