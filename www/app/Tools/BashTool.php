...
```bash
# Git operations
pd bash --command="git status"
pd bash --command="git log --oneline -10"

# Package management
pd bash --command="composer install"
pd bash --command="npm run build"

# With timeout for long operations
pd bash --command="npm install" --timeout=300
```
