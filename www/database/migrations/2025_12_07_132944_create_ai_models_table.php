...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ai_models', function (Blueprint $table) {
            ...
            $table->decimal('cache_write_price_per_million', 10, 4)->nullable();
            $table->decimal('cache_read_price_per_million', 10, 4)->nullable();
            ...
            $table->index('model_id'); // For direct model lookups
        });
    }
