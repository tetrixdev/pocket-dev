...
<body class="bg-gray-900 text-white min-h-screen p-6">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-6">
            <a href="{{ route('config.skills.create') }}" class="px-6 py-2 bg-green-600 hover:bg-green-700 text-white rounded font-medium inline-block">
                Create New Skill
            </a>
        </div>
