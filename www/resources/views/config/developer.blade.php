...
<div class="max-w-2xl">
    ...
    <div class="bg-gray-800 rounded-lg p-6 mb-6">
        <h2 class="text-lg font-semibold mb-2">Force Recreate Containers</h2>
        <p class="text-gray-400 text-sm mb-4">
            Runs <code class="bg-gray-900 px-2 py-1 rounded">docker compose up -d --force-recreate</code> to rebuild all containers.
            Use this after changing frontend assets (JS, CSS, Alpine.js directives).
        </p>
...
document.getElementById('force-recreate-form').addEventListener('submit', function(e) {
    ...
    // First confirmation
    if (!confirm('Are you sure you want to force recreate all containers? This will briefly interrupt the application.')) {
        return false;
    }

    @if($processingCount > 0)
    // Second confirmation for processing conversations
    ...
    // All confirmations passed, submit the form
