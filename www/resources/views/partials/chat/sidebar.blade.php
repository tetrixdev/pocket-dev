...
<div class="w-64 h-full bg-gray-800 border-r border-gray-700 flex flex-col">
    <div class="p-4 border-b border-gray-700">
        ...
        <div class="flex items-center gap-2">
            ...
            <button @click="newConversation()"
                    class="flex-1 py-2 rounded-lg text-sm flex items-center justify-center gap-2 transition-colors bg-emerald-600/90 hover:bg-emerald-500 text-white cursor-pointer"
    ...
    <div x-show="!conversationSearchQuery" class="flex-1 overflow-y-auto p-2" id="conversations-list" @scroll="handleConversationsScroll($event)">
    ...
    <div x-show="conversationSearchQuery" x-cloak class="flex-1 overflow-y-auto p-2">
        ...
        <template x-for="result in conversationSearchResults" :key="result.conversation_uuid + '-' + result.turn_number">
            <div @click="loadSearchResult(result)"
                ...
                {{-- Date + Agent (like normal conversations) --}}
                <div class="flex items-center gap-2 text-xs text-gray-500 mt-0.5">
