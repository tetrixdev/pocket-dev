...
<div x-show="showMobileDrawer"
    ...
    <div x-show="showSearchInput" x-cloak class="px-4 pt-3 pb-3 border-b border-gray-700">
        ...
        <div class="flex gap-1 mb-3">
            <button @click="sidebarSearchMode = 'sessions'; $nextTick(() => $refs.mobileSearchInput?.focus())"
            ...
            <button @click="sidebarSearchMode = 'conversations'; $nextTick(() => $refs.mobileConversationSearchInput?.focus())"
        ...
        <div x-show="sidebarSearchMode === 'conversations'">
            <div class="relative">
                <input type="text"
                       ...
                       x-ref="mobileConversationSearchInput"
