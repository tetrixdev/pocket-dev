...
<template x-if="msg.role === 'interrupted'">
    <div class="max-w-[85%] md:max-w-3xl w-full">
        <div class="flex items-center gap-2 px-3 md:px-4 py-2 rounded-lg border border-red-500/30 bg-red-900/20">
            ...
            <span class="text-xs text-gray-500 ml-auto" x-text="formatTimestamp(msg.timestamp)"></span>
        </div>
    </div>
</template>
