...
echo "  • PocketDev will be accessible at: https://dev.example.com"
echo "  • All subdomains are automatically covered: *.dev.example.com"
echo "  • Deploy apps as subdomains without additional DNS/SSL setup:"
echo "      - app1.dev.example.com"
echo "      - staging.dev.example.com"
echo "      - api.dev.example.com"
echo ""
echo -e "${CYAN}Access control:${NC}"
echo "  • Public apps: Accessible from anywhere"
echo "  • Private apps: Restrict to Tailscale network via IP whitelist"
